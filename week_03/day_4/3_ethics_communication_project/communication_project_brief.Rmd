...
* Understand what is required for the ethics & communication project
* Get an introduction to the questions to choose from
* Get an introduction to the presentation approach

**Duration - 15 minutes**<br>

# Ethics and AI Presentation

This afternoon we would like you to research a topical question around ethics and create so present it back to the group tomorrow morning.

## Presentation

**You will have 5 minutes for the presentation, and there will be time to take a couple of questions at the end.** You will present on Friday morning. The idea is that you get used to giving short, succinct, elevator pitch type presentations on a complex technical topic. It's supposed to be fun, informative, and presented as if you're talking to someone that has no idea about data, ethics, or the topic you're speaking about! 


We expect you to:

* Summarise the topic you are discussing
* Identify the ethical challenges/ambiguities
...
* Focus on getting your points across clearly and succinctly
* Do not go over the time limit
* Use visuals to bring the topic to life

## Notes

* Please create some slides for the presentation. You can create your slides in whatever presentation software you like. Google Slides and Canva are some good free options.
* Choose your topic from one of the briefs below, or if you have something else in mind you are free to present on your own topic - as long as it is somehow related to data and ethics.
...
Here are some potential topics you can present on. You can also feel free to choose your own!
...
We'd like you to consider how to identify inherent bias in the datasets, how to compensate for that, and how to deal with this. 
...
Recent advances in technology have triggered a shift towards more distributed power generation from many small-scale sources rather than few large-scale power plants. This requires at least a partial redesign of the grid, including smart meters, to guarantee secure operations. Smart meters enable companies better grid management, but they also come with privacy concerns: meter readings can be used to determine when someone is home, what your daily life is like, and even offer you targeted rates that are different (and maybe more expensive) than your next door neighbour. 

We'd like you to consider these and other issues related to smart technology in the home. 


## How can data science be used for the good of society?

It's not all doom and gloom in data. Lots of evidence shows that data can be used to improve public policy, improve well being, assist in learning and social care, and create safter and more ethical societies. 

We'd like you to discuss a topic related to data for good!